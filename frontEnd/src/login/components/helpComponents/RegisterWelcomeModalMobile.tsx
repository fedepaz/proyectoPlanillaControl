// src/register/components/RegisterWelcomeModalMobile.tsx
"use client";
...
interface RegisterWelcomeModalMobileProps {
  open: boolean;
  onGetStarted: () => void;
  features: Feature[];
}

function RegisterWelcomeModalMobile({
  open,
  onGetStarted,
  features,
}: RegisterWelcomeModalMobileProps) {
        ...
        >
          ...
          >
            ...
            <Typography variant="body2">
              ...
              <br />• Debes elegir una <strong>constraseña</strong> que tenga 9
              caracteres mínimo y no sea 123456789
              <br />• No son necesarios <strong>caracteres especiales</strong>
              <br />• Si olvidas tu contraseña, no podrás acceder a tu cuenta
              <br />• Administre los medios...
            </Typography>
          </Alert>
        </Box>
...
export default RegisterWelcomeModalMobile;
